...
namespace RabbitHutch.DependencyInjection
{
    ...
    public class RabbitPublisherBuilderConfigurationContext<T>
    {
        /// <summary>
        ...
        /// </summary>
        public Func<T, string>? SerializerDelegate { get; private set; }

        /// <summary>
        /// Gets the routing key delegate.
        /// </summary>
        public Func<T, string>? RoutingKeyDelegate { get; private set; }

        /// <summary>
        /// Gets the connection lifecycle profile.
        /// </summary>
        public IConnectionLifecycleProfile ConnectionLifecycleProfile { get; private set; } = ConnectionLifecycleProfiles.DefaultPublisherConnectionLifecycleProfile();
        ...
        {
            RoutingKeyDelegate = routingKeyGenerator;
            return this;
        }
